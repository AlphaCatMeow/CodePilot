...
| Windows | [インストーラー (.exe)](https://github.com/AlphaCatMeow/CodePilot/releases/latest) | x64 + arm64 |
| Linux | ソースからビルド | x64 + arm64 |

または [Releases](https://github.com/AlphaCatMeow/CodePilot/releases) ページで全バージョンを確認できます。
...
- [GitHub Issues](https://github.com/AlphaCatMeow/CodePilot/issues) -- バグ報告と機能リクエスト
- [GitHub Discussions](https://github.com/AlphaCatMeow/CodePilot/discussions) -- 質問と一般的なディスカッション
